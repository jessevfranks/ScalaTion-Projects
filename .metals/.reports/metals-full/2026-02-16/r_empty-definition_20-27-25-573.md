error id: file://<WORKSPACE>/src/main/scala/project1/Project1Utils.scala:Array#
file://<WORKSPACE>/src/main/scala/project1/Project1Utils.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scalation/mathstat/Array#
	 -Array#
	 -scala/Predef.Array#
offset: 256
uri: file://<WORKSPACE>/src/main/scala/project1/Project1Utils.scala
text:
```scala
package project1
...
class Project1Utils(x: MatrixD, y: VectorD, fname: Ar@@ray[String]) {
